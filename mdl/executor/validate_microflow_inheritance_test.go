...
func TestValidateMicroflow_EnumSplitAllCasesReturnWithoutElse(t *testing.T) {
	input := `create or modify microflow Test.DispatchByStatus ($Status: enum Test.Status)
returns String
begin
  split enum $Status
  case Open
